...
@Configuration
@EnableJpaRepositories("com.danielme.blog.hibernatefetching.repositories")
@PropertySource("classpath:db.properties")
@ComponentScan("com.danielme.blog")
@EnableTransactionManagement
public class ApplicationContext {
    
    private static final String ENTITY_PACKAGE = "com.danielme.blog.hibernatefetching.entities";
